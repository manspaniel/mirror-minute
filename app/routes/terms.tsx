    ...
    <div>
      <div className="max-w-[1300px] px-5 md:px-20 mx-auto text-indigo-950">
        ...
        <div className="mx-auto md:max-w-[60%] pt-5 md:pt-10 privacy-text">
          <h1 className="font-sans uppercase text-4xl mb-5">
            Website Terms of Use
          </h1>

          <p>
            <strong>Laugh Lines Film Pty Ltd ABN 39684054251</strong> (we, our
            or us) operates this website (Site). The domain address of the Site
            is: www.mirrorminute.com and it may also be available through other
          ...
          <p>
            ...
            website terms of use (Terms). If you do not agree to these Terms,
            you must discontinue use of our Site immediately.
          </p>

          <h2>When we can change these Terms</h2>
          <p>
            We may update these Terms from time to time. Any changes will be
            effectively immediately upon posting on our Site. Your continued use
            of our Site following any changes constitutes acceptance of the
            revised terms. We recommend checking this page regularly to stay
          ...
          <p>
            ...
            the Site at any time without notice. While we strive to maintain
            accurate and current information, we make no guarantees that the
            Site will always be up to date.
          </p>

          <h2>Use of the Site</h2>
          <p>
            We grant you a limited, non-exclusive, revocable, worldwide,
            non-transferable licence to use our Site for personal and
            informational purposes. You must not:
          </p>
          <ul>
            <li>
              copy reproduce, distribute or otherwise use content from the Site
              (Content) without permission;
            </li>
            <li>
              use our Site or Content in a manner that competes with our
              business;
            </li>
            <li>infringe upon our intellectual property rights; or</li>
            <li>
              engage in any unlawful or prohibited activities as outlined in
              these Terms.
            </li>
          </ul>

          <h2>User conduct</h2>
          <p>When using our Site, you must not:</p>
          <ul>
            <li>engage in any activity that is illegal, fraudulent or harmful;</li>
            <li>defame, harass, threaten, or offend others;</li>
            <li>interfere with other users access to the Site;</li>
            <li>introduce viruses, trojans or other harmful software;</li>
            <li>collect data from our Site by automated means; or</li>
            <li>impersonate any person or entity.</li>
          </ul>

          <h2>Information disclaimer</h2>
          <p>
            The content on our Site provides general information only and does
            not constitute legal, medical, financial or professional advice. You
            acknowledge that reliance on any information provided on this Site
            is at your own risk and we are not liable for any loss or damage
            arising from such reliance. To the maximum extent permitted by law,
            we make no representation, warranty or guarantee with respect to the
            Content or the likely outcomes you will get if you action the
            information on our Site and apply it to your situation or life. You
            should always get professional advice about your circumstances from
            an appropriate and qualified professional.
          </p>

          <h2>Intellectual Property rights</h2>
          <p>
            Unless otherwise stated, we own or licence all intellectual property
            rights in our Site and its Content. You may not:
          </p>
          <ul>
            <li>
              copy, modify, reproduce, publish or distribute our Content without
              written permission;
            </li>
            <li>create derivative works based on our Content; or</li>
            <li>frame or embed our Content in another website.</li>
          </ul>

          <h2>Third party websites</h2>
          <p>
            Our Site may contain links to third party websites (Third Party
            Sites). We do not endorse, control or accept responsibility for any
            Third Party Sites or their content. You use of Third Party Sites is
            at your own risk.
          </p>

          <h2>User generated content</h2>
          <p>
            If you submit or upload content (User Content) to our Site, you
            grant us a worldwide, irrevocable, perpetual, non-exclusive,
            transferable, royalty-free licence to use, modify and distribute
            that User Content. You warrant that:
          </p>
          <ul>
            <li>you own or have the necessary rights to the User Content;</li>
            <li>
              the User Content does not violate any laws or third party rights;
              and
            </li>
            <li>you are responsible for all User Content you upload.</li>
          </ul>
          ...
          <p>
            ...
            or warranties about our Site or its Content, including that:
          </p>
          <ul>
            <li>it is accurate, complete or up to date;</li>
            <li>access to the Site will be uninterrupted; and</li>
            <li>it is free from errors, viruses, or harmful components.</li>
          </ul>
          ...
          <ul>
            ...
            <li>errors, omissions, or inaccuracies in Content; or</li>
            <li>loss of data, or unauthorised access to information.</li>
          </ul>

          <h2>Indemnity</h2>
          <p>
            You agree to indemnify us, and hold us harmless against any claims,
            losses, liabilities or expenses arising from your:
          </p>
          <ul>
            <li>use of our Site;</li>
            <li>breach of these Terms; and</li>
            <li>infringement of any third party rights.</li>
          </ul>
          <p>This indemnity continues after the termination of these Terms.</p>

          <h2>Termination of access</h2>
          <p>
            We may suspend or terminate your access to our Site at any time,
            without notice, if you breach these Terms or for any other reason.
            We are not liable for any loss or damage resulting from such
            termination.
          </p>
          ...
          <p>
            ...
            agree to submit to the exclusive jurisdiction of the course in that
            State. If accessing this Site outside Australia, you do so at your
          ...
          <p>
            <strong>
              LAUGH LINES FILM PTY PTD - Cait Miers ABN 39684054251
            </strong>
          </p>
          <p>
            Email:{" "}
            <a href="mailto:hello@laughlines.com.au" className="underline">
              hello@laughlines.com.au
            </a>
          </p>
          <p>Last update: 11/05/2026</p>
        </div>
      </div>
      <div className="my-20">
